...
function listStages(stages, cmcDir/*, random*/) {
    let output = "<tr><th>Image</th><th>Name</th><th>Extract</th><th>Remove</th></tr>";/*<th>Random Selection</th>*/
    ...
    for (let stage of sorted) {
        ...
        output += 
        "<tr id=\"" + stage.number + "\">\n\
            <td class=\"mug\"><image src=\"" + cmcDir + "/gfx/stgicons/" + stage.name + ".png\" draggable=\"false\" onerror=\"this.onerror=null; this.src='" + cmcDir.replaceAll("\\", "\\\\") + "/gfx/stgicons/empty.png'\" /></td>\n\
